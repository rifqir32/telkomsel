      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Tambah posting</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."posting_add/do_insert"; ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama posting</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama posting" name="kategori_makanan" required>
                    </div>
                  </div><!-- /.box-body -->
