...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?php echo base_url()."assets/admin/"?>angular.js"></script>
  ...
  <body class="hold-transition skin-red sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              <a href= "<?php echo base_url()."driver_add";?>"><button type="submit" class="btn btn-primary"> + Tambah   Driver</button></a>

              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Kelola   Driver</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url()."kelola_driver/edit_menu/".$d['id_driver']; ?>">Edit</a>
                          <a href="<?php echo base_url()."kelola_driver/do_delete/".$d['id_driver']; ?>">Delete</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
