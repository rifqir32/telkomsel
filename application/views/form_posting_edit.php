          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."kelola_posting/do_update"; ?>" enctype="multipart/form-data">
                  <input type="text" name="id_kategori_makanan" value="<?php echo "$data[id_kategori_makanan]"; ?>" hidden/>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama posting</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama posting" name="kategori_makanan" value="<?php echo "$data[kategori_makanan]"; ?>" required>
                    </div>
                  </div><!-- /.box-body -->
