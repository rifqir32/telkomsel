...
<head>
    ...
    <link href="<?php echo base_url("/assets/bootstrap-theme.min.css"); ?>" rel="stylesheet" />
    <link href="<?php echo base_url("/assets/jquery.reject.css"); ?>" rel="stylesheet" media="screen" />
...
<div id="body" class="frontpage">
    <div id="body-inner">
        <header id="header">
            <div class="container">
                <div class="logo"><img src="<?php echo base_url("/assets/image/logo.png") ?>" alt=""/></div>
        ...
        <section>
            <div id="content-home" class="container">
                ...
                <div class="row kotak3 hideOnLoad showOnLoad3">
                    <div class="col-md-12">
                        <center><h3>Pesan gagal dikirim, Coba Ulangi</h3></center>
                        <br><br><br>
                        <center><small><a href="<?php echo base_url()."contacts"; ?>">Retry</a></small></center>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-bottom: 0; padding-bottom: 0;">
                                <div class="col-md-3">
                                    ...
                                    <div class="copyright">
                                        <div class="logo left hidden-xxs"><img src="<?php echo base_url("/assets/image/pita.png") ?>" alt=""/></div>
...
<script src="<?php echo base_url("/assets/js/jquery.reject.js") ?>"></script>
