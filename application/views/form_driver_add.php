...
<html>
  <head>
    ...
    <title>Telkomsel Admin Panel</title>
  ...
  <body class="hold-transition skin-red sidebar-mini">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url("")."home_admin"; ?>" class="logo">
          ...
          <span class="logo-lg"><b>Telkomsel's</b> Admin</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Telkomsel Admin</span>
                </a>
          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."driver_add/do_insert"; ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label>NOPOL</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan NOPOL Kendaraan" name="NOPOL" required>
                    </div>
                    <div class="form-group">
                      <label>Nama Driver</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama driver" name="nama_driver" required>
                    </div>
                    <div class="form-group">
